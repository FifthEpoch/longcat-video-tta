...
echo "================================================================================"
echo ""
echo "--- Delta-A Batch-Size (Series 37): batch_videos={1,5,10,50,1000} ---"
scan "${RESULTS_ROOT}/exp5_batch_size_delta_a" "BS_DA"
echo ""
echo "--- LoRA Batch-Size (Series 38): batch_videos={1,5,10,50,1000} ---"
scan "${RESULTS_ROOT}/exp5_batch_size_lora" "BS_L"
echo ""
echo "--- Full-Model Batch-Size (Series 39): batch_videos={1,5,10,50,1000} ---"
