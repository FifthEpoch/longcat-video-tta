...
echo ""
echo "Router deploy (after feature extract on preview 1000):"
echo "  SERIES_ROOT=${PROJECT_ROOT}/${RESULTS_SUBDIR} \\"
echo "      bash scripts/run_deploy_strict_router_experiments.sh  # adjust paths"
echo "============================================================"
