#!/bin/bash
# Submit 200-video anchor-regularization noise-draw sweeps.
#
# Defaults to DRY_RUN=1 so it is safe to run locally or on the cluster.
# To submit for real:
#   DRY_RUN=0 bash sweep_experiment/sbatch/submit_anchor_reg_draws_200.sh
...
run_sweep sweep_experiment/configs/panda_200_anchor_reg_draws.yaml \
  "${PROJECT_ROOT}/datasets/panda_200_480p"
run_sweep sweep_experiment/configs/ucf101_200_anchor_reg_draws.yaml \
