...
| exp9_multitask_aestech | **45.1†** | 26.5 | **NO†** | †In-sample leak; rerun with OOF fix |
...
**exp10 (18.4%)** uses ground-truth VBench Aes+IQ on probe configs (not DOVER-on-frames); treat as ceiling for probe+DOVER routing, not a deployable policy.  
**exp9 (45.1%)** invalidated by in-sample evaluation bug; corrected script reruns OOF picks from proxy ridge then evals on total VBench.
