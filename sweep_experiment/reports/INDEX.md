...
**Owners:** Wenchen (PI) and any active agent. Last updated: 2026-08-18.
...
| `i2v_bon_32v_hybrid` | 32 | 30 s (5×24 lat) | NOTTA, always-BoN k=4, gated-BoN hybrid (ch1>0.8 / late>2.0 / Δ>0.5∧prev>0.5) | **DONE 2026-08-17** n_ok=32/32. Official VBench **SUBMITTED** job 15959601 (PD Priority at 11:47) | `wan_experiment/results/i2v_bon_32v_hybrid/` | Cite medians, not means (video 26 = 85.6). Median last-chunk NOTTA 3.68 / always 2.97 / gated 3.04. gated−always −0.041 mean / 0 median, 19/32 better-or-tie. 33% cheaper (173 vs 258 s). First-16 pairing held; hybrid flipped T=2.0 gated−always +0.15 → −0.12. Efficiency **on the handcrafted score only** — official VBench not scored yet. Tables: [`2026-08-17_wan_i2v_bon32_hybrid.md`](paper_tables/2026-08-17_wan_i2v_bon32_hybrid.md), spec [`2026-08-18_wan_i2v_official_eval_spec.md`](paper_tables/2026-08-18_wan_i2v_official_eval_spec.md), jobs [`2026-08-18_wan_in_flight_jobs.md`](paper_tables/2026-08-18_wan_in_flight_jobs.md). |
...
| `i2v_bon_32v_sick` | 32 | 30 s (5×24 lat) | gated-BoN search-while-sick (sticky + off if recovered>0.5 or outgoing<1.0) | **RUNNING** job 15959146 (R 14:15 on gh107 at 11:47) | `wan_experiment/results/i2v_bon_32v_sick/` | Stay on only while the last second looks sick. Built to keep 11/16 hybrid wins and 03/24 always-search catches. Spec: [`2026-08-18_wan_i2v_sick_gate_spec.md`](paper_tables/2026-08-18_wan_i2v_sick_gate_spec.md). Check commands: [`2026-08-18_wan_in_flight_jobs.md`](paper_tables/2026-08-18_wan_in_flight_jobs.md). |
...
| `i2v_bon_32v_hybrid` official VBench | Paper-blocking. Handcrafted last-chunk is the controller signal, not the quality claim. 11/16 showed the pick-score can lie. Need do-nothing / always / gated on common VBench dims + Spearman vs last-chunk. | **SUBMITTED** job 15959601 (PD Priority at 11:47; waits behind 15959146). | last5 then full. No PSNR (no 30 s GT on these stills). Spec: [`2026-08-18_wan_i2v_official_eval_spec.md`](paper_tables/2026-08-18_wan_i2v_official_eval_spec.md). Check: [`2026-08-18_wan_in_flight_jobs.md`](paper_tables/2026-08-18_wan_in_flight_jobs.md). |
