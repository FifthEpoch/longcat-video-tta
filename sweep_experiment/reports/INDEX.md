...
| `i2v_bon_16v` | 16 | 30 s (5×24 lat) | NOTTA, always-BoN k=4, gated-BoN k=4 (gate=2.0) | **DONE 2026-08-17** jobs 15884598/599/600 | `wan_experiment/results/i2v_bon_16v/` | Seed match 16/16. always left cand0 43/64. gated fired 27/64, skipped 4 videos (=NOTTA). Wall 84 / 267 / 211 s. Quality vs always-on not yet scored. Table: [`2026-08-17_wan_i2v_bon16.md`](paper_tables/2026-08-17_wan_i2v_bon16.md). |
