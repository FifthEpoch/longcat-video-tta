...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **PROTOCOL PASS 2026-08-24 20:31.** notta/rolling/rewind **32/32 COMPLETED 0:0**, `metadata_csv`. Tails 0.01164 / 0.01423 / 0.01262. Rolling 23/9/0; rewind 23/5/4. **16310321** sick R. VBench **16310330**. | Handcrafted only. [`hosts`](paper_tables/2026-08-24_wan_v2v_caption_wave1_hosts.md). |
