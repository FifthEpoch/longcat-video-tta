...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **FAILED 2026-08-24.** inference_mode killed `loss.backward`. Fix in `wan_adasteer.py`. Resubmit N=8 after pull. | Not a null. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
