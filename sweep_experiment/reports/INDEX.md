...
| `panda_1000v_retrieval` | Panda-70M | 999 | 28 | K5_SIM, K5_RAND, K10_SIM, K10_RAND | DONE merged 2026-07-05 (pool `panda_2048_480p`) | `sweep_experiment/results/panda_1000v_retrieval/` | [`paper_tables/2026-07-05_panda_1000v_retrieval.md`](paper_tables/2026-07-05_panda_1000v_retrieval.md) | SIM≈RAND (ΔPSNR≤0.03). Retrieval batch-TTA does not beat ADA on PSNR/FVD; Aes~0.442 (LoRA-like bump, confirm 7-dim). |
