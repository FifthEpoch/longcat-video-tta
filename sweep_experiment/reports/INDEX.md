...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **SF RESUBMIT FAILED 2026-08-27.** 16471672–677 all **2:0**. Smoke ~12 min, N=8 ~54 min. RF still NO. | Do not relaunch without traceback. [`harvest`](paper_tables/2026-08-27_wan_v2v_intra8_harvest.md). |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | **LASTMIX GENERATE 0:0 2026-08-28.** 827–836 + VBench 832/837 COMPLETED. Relative ls mp4=0 — find pending. | Do not call. Do not paste bpseudo/restep. Spec: [`2026-08-28_wan_v2v_denoise_hooks_spec.md`](paper_tables/2026-08-28_wan_v2v_denoise_hooks_spec.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. **WAVE=hosts** = notta + rolling. **WAVE=cite** = Pseudo + Always. **N=128**. | **GENERATE 0:0 2026-08-28.** **16506077** 2h53, **078** 1h15. VBench **079 CANCELLED** 2h28. Relative ls mp4=0 — find pending. | Do not regenerate. Resubmit VBench after files confirmed. [`hold vs 128`](paper_tables/2026-08-28_hold_vs_n128.md). |
