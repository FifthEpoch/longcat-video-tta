...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`. Caption **N=8**. | **RESUBMIT 2026-08-30** CPU-snap. RF intra stays closed. | [`oom`](paper_tables/2026-08-30_wan_v2v_oom_cpu_snap.md). Paste WAVE=sf. |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | lastmix / sf_bpseudo / rf_restep **NO**. **RESUBMIT** SF restep + RF bpseudo (`WAVE=crash`). | [`in-chunk`](paper_tables/2026-08-30_wan_v2v_inchunk_harvest.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. **WAVE=cite** = Pseudo + Always on same 128. | Hosts scored. **CITE LAUNCH 2026-08-30.** Do not regenerate notta / rolling. | [`hosts`](paper_tables/2026-08-30_wan_v2v_caption128_hosts.md). Next ideas: [`intrablock`](paper_tables/2026-08-30_wan_v2v_intrablock_next.md). |
