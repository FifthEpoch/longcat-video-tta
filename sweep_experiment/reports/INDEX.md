...
**Owners:** Wenchen (PI) and any active agent. Last updated: 2026-08-21.
...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **DONE 2026-08-21.** Generate + VBench 16122823. | **seed_bon FAIL as a Dyn method.** Tail −8.8% (12/32). VBench Dyn **0/0**. Subject **+0.039**, IQ −0.77. Identity damper. Table: [`2026-08-21_wan_v2v_overnight_vbench.md`](paper_tables/2026-08-21_wan_v2v_overnight_vbench.md). |
...
| `v2v_panda_lineage_8v` | live_bon, live_hist, longlive_notta, longlive_sink, longlive_prefix_sink, longlive_live_bon, rolling_notta. Same 8. | **PARTIAL 2026-08-21 12:33.** 808/809/811 DONE. live_* **+37%, 0/8 losses vs notta**. 0002/0003 exact notta (seed damped). 0000 false-skip. longlive HOLD. 812–815 + VBench + ideas queued. | Per-video: [`2026-08-21_wan_v2v_lineage_pervideo.md`](paper_tables/2026-08-21_wan_v2v_lineage_pervideo.md). Do not scale to 32. |
...
| `v2v_panda_ideas_8v` | appear_bon, live_appear, pseudo_gate, pseudo_appear, noise_probe, noise_bon. Same 8 as bake-off. | **QUEUED 2026-08-21 11:46.** Jobs **16145125–130** PD Priority; VBench **16145131** afterany. | Mapping: 125 appear_bon, 126 live_appear, 127 pseudo_gate, 128 pseudo_appear, 129 noise_probe, 130 noise_bon. Spec: [`2026-08-21_wan_v2v_ideas_submit.md`](paper_tables/2026-08-21_wan_v2v_ideas_submit.md). |
| `v2v_panda_live_32v` | live_bon only. N=32. Same prefix set as confirm_32v. live_min=0.012. | **QUEUED 2026-08-21 12:45.** Generate **16147007** PD Priority; VBench **16147008** afterany. | Yes/no vs confirm notta. Behind lineage 812–815 + ideas 125–130 (QOSMaxGRESPerUser). Spec: [`2026-08-21_wan_v2v_live32_yesno.md`](paper_tables/2026-08-21_wan_v2v_live32_yesno.md). |
