...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **SF RESUBMIT 2026-08-27.** 16471672–673 smoke + 675–676 N=8 PD `QOSMaxGRESPerUser`. VBench 674/677. RF still NO. | KV shadow fix `db4fe2e`. Do not scancel. [`harvest`](paper_tables/2026-08-27_wan_v2v_intra8_harvest.md). |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | **LASTMIX IN FLIGHT 2026-08-28.** Smoke **16505827/829** R; 830/831 + N=8 **833–836** PD GRES. VBench 832/837. | Spec: [`2026-08-28_wan_v2v_denoise_hooks_spec.md`](paper_tables/2026-08-28_wan_v2v_denoise_hooks_spec.md). Do not paste bpseudo/restep yet. Do not rerun RF intra. |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. **WAVE=hosts** = notta + rolling. **WAVE=cite** = Pseudo + Always. **N=128**. | **HOSTS IN FLIGHT 2026-08-28.** Seeded 32/32. **16506077/078** PD GRES; VBench **16506079**. | Reuse worked. Generate 96. Do not mix stem rolling-128. [`hold vs 128`](paper_tables/2026-08-28_hold_vs_n128.md). |
