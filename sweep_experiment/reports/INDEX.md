...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **PROTOCOL PASS 2026-08-24 20:46.** Hosts+rewind 32/32. Sick **16310321** 6/32 + pseudo **16310322** 3/32, both `metadata_csv`. 323–329 + AdaSteer PD. VBench **16310330**. | Hosts peek: [`hosts`](paper_tables/2026-08-24_wan_v2v_caption_wave1_hosts.md). Search not harvested. |
