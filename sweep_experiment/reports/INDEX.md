...
| `v2v_panda_bakeoff_8v` | notta, seed_bon, motion_bon, backtrack. **No shift_search** (probe dead). | **GENERATE DONE 2026-08-20.** Jobs 16092846–849 all 0:0. N=8. | seed_bon tail motion **0.0225 vs notta 0.0167 (+35%)**. motion_bon 0.0148 and backtrack 0.0130 **lost**. VBench not scored — seed_bon is CONDITIONAL. Table: [`2026-08-20_wan_v2v_bakeoff_8v.md`](paper_tables/2026-08-20_wan_v2v_bakeoff_8v.md). |
