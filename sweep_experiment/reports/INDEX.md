...
| `v2v_panda_sf_family_32v` | Same four widgets on **SF chunked**: `sf_rewind`, `sf_sick_search` k=4, `sf_pseudo` k=4, `sf_sink`. **N=32**. | **IN FLIGHT 2026-08-24.** Rewind resume **16267992**. sick **879** / pseudo **880** R. sink **881** off queue. VBench **16268053** afterok 16267992:16266879:16266880. | Field claim: method-on-SF vs SF notta. RF rolling is comparison only. No `sf_roll`. Harvest playbook: [`dissect`](paper_tables/2026-08-24_wan_v2v_sf_family_dissect.md). Spec: [`2026-08-24_wan_v2v_sf_family_spec.md`](paper_tables/2026-08-24_wan_v2v_sf_family_spec.md). |
