...
| `v2v_panda_rolling_128v` | SF notta + rolling_notta. N=128. Same prefix set as N=32. | **Flickering job DONE 2026-08-23.** **16259396** COMPLETED 0:0 5m36s; file on disk. Official 7-dim waits on join-only n. | Locked bars PASS. Dyn first32 med 0 (14/32); last96 med 1 (54/96). Host, not ours. [`vbench6`](paper_tables/2026-08-23_wan_v2v_rolling128_vbench6_read.md) [`dyn split`](paper_tables/2026-08-23_wan_v2v_rolling128_dyn_split.md). |
...
| `v2v_panda_family_32v` | Family A/B/C/D on RF: `rf_rewind`, `rf_sick_search` k=4, `rf_pseudo` k=4, `rf_sink`. **N=32**. Offline chunk-trace on 8/32/128 in the same paste. | **IN FLIGHT 2026-08-23.** 273 rewind / 274 sick_search / 275 pseudo **R**; 276 sink PD GRES; 277 VBench `l40s_mren` Dependency. | Paper baseline SF notta; ablation `rolling_notta`. C is a sink probe, not HG-f. Generate = H200 × 2 video workers; VBench = L40S. Spec: [`2026-08-23_wan_v2v_family_wave_spec.md`](paper_tables/2026-08-23_wan_v2v_family_wave_spec.md). GPU: [`2026-08-23_wan_gpu_batch_policy.md`](paper_tables/2026-08-23_wan_gpu_batch_policy.md). |
