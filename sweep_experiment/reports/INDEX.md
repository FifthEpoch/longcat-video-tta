...
| `i2v_bon_32v_hybrid` | 32 | 30 s (5×24 lat) | NOTTA, always-BoN k=4, gated-BoN hybrid (ch1>0.8 / late>2.0 / Δ>0.5∧prev>0.5) | **DONE 2026-08-17** n_ok=32/32. Official VBench job 15959601 **INCOMPLETE** (notta only; comma `--export` bug) | `wan_experiment/results/i2v_bon_32v_hybrid/` | Cite medians, not means (video 26 = 85.6). Median last-chunk NOTTA 3.68 / always 2.97 / gated 3.04. gated−always −0.041 mean / 0 median, 19/32 better-or-tie. 33% cheaper (173 vs 258 s). First-16 pairing held; hybrid flipped T=2.0 gated−always +0.15 → −0.12. Efficiency **on the handcrafted score only**. Resubmit VBench after pull. Tables: [`2026-08-17_wan_i2v_bon32_hybrid.md`](paper_tables/2026-08-17_wan_i2v_bon32_hybrid.md), spec [`2026-08-18_wan_i2v_official_eval_spec.md`](paper_tables/2026-08-18_wan_i2v_official_eval_spec.md). |
...
| `i2v_bon_32v_hybrid` official VBench | Paper-blocking. Handcrafted last-chunk is the controller signal, not the quality claim. Need do-nothing / always / gated on common VBench dims + Spearman vs last-chunk. | Job 15959601 **INCOMPLETE**: do-nothing last5+full only. SLURM `--export` comma bug. Fix pushed; resubmit `submit_i2v_vbench_hybrid32.sh`. | last5 then full. No PSNR. Spec: [`2026-08-18_wan_i2v_official_eval_spec.md`](paper_tables/2026-08-18_wan_i2v_official_eval_spec.md). |
