...
| `v2v_panda_forward_32v` | rolling_notta + appear_bon. N=32. Reuse confirm notta. | **QUEUED 2026-08-21 23:12.** **16179112** rolling, **16179113** appear, VBench **16179114**. | N=8 diagnose: prefix_sink / LongLive-notta / live_hist Dyn **CLOSED**. Flicker ρ=−1 is tautological. Table: [`2026-08-21_wan_v2v_mixed_diagnose.md`](paper_tables/2026-08-21_wan_v2v_mixed_diagnose.md). |
| collapse+band picker resim | Offline on seed_bon-8/32 + live_bon-32 cand logs. | **SUBMIT-READY 2026-08-22.** Zero GPU. | Earn a generate only if 0022/0027/0028 stay cand0. Spec: [`2026-08-22_wan_v2v_collapse_band_resim.md`](paper_tables/2026-08-22_wan_v2v_collapse_band_resim.md). |
