...
| Wan Panda-prefix pixel audit | Caption-128 sources: min 55 s / med 314 s / max 1824 s. **128/128 ≥ 32 s.** | **SPEC READY.** L40S scorer, no new generate. | [`spec`](paper_tables/2026-08-31_wan_v2v_pixel_metrics_spec.md). Headline stays VBench + Dyn%. |
