...
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | **SUBMIT-READY 2026-08-28.** `WAVE=lastmix` first (GRES). | Spec: [`2026-08-28_wan_v2v_denoise_hooks_spec.md`](paper_tables/2026-08-28_wan_v2v_denoise_hooks_spec.md). Do not rerun RF intra. |
