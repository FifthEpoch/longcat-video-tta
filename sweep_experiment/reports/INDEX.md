...
| Caption pwarp N=8 spec | Slide `pred` after pass 1. Ordinary extras. SF host. | SUBMIT-READY. `sf_pwarp` + `sf_pwarp_live`. Cite caption SF first-8. | [`2026-09-06_wan_v2v_caption_pwarp_spec.md`](paper_tables/2026-09-06_wan_v2v_caption_pwarp_spec.md). |
