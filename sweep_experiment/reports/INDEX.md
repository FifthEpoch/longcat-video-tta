...
| `v2v_panda_lineage_8v` | live_bon, live_hist, longlive_notta, longlive_sink, longlive_prefix_sink, longlive_live_bon, rolling_notta. Same 8. | **PARTIAL 2026-08-21 12:24.** 808/809/811 DONE n=8. live_bon/live_hist tail **0.0229 vs notta 0.0167 (+37%)**. longlive_notta 0.015 HOLD. 812–815 + VBench + ideas still queued. | Script printed PROMOTE; honest = conditional (VBench missing; last-chunk bit-matches notta). Table: [`2026-08-21_wan_v2v_lineage_partial.md`](paper_tables/2026-08-21_wan_v2v_lineage_partial.md). |
