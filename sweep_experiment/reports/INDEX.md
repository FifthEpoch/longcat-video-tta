...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **GENERATE MOSTLY IN 2026-08-24 22:45.** Sick 32/32 tail **+0%**. Sink +64%. RF family 32/32. Pseudo 27 + always 9 still R. VBench **16310330** PD. | [`outcomes`](paper_tables/2026-08-24_wan_v2v_caption_wave1_outcomes.md). No VBench. No HOLD. |
...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **FAILED 2026-08-24.** **16314667–669** 2:0 in 3m, 0 mp4. VBench **16314670** cancelled. Hook/fit crash, not a null. | Do not resubmit until error json. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
