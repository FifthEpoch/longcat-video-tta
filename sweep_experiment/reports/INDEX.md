...
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | **LASTMIX NO 2026-08-29.** SF subj **0.629** / IQ **69.63**. RF **0.657** / **65.53**. Gated ≈ always. | Do not scale. Do not retune 1.5×. [`harvest`](paper_tables/2026-08-29_wan_v2v_lastmix8_harvest.md). |
