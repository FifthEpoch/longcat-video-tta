...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **GENERATE DONE 2026-08-21.** 32/32 mp4s. `summary.json` skip-stubs for ~20 clips (no `tail_motion`). | **−26% KILL RETRACTED.** Honest pair is n=12 (0020–0031): 0.01380→0.01424 (+3%), 5/12. Need sidecar rebuild of 0000–0019. Table: [`2026-08-21_wan_v2v_pervideo_retract.md`](paper_tables/2026-08-21_wan_v2v_pervideo_retract.md). |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. | **GENERATE DONE 2026-08-21.** 8/8 mp4s all 6 methods. VBench pending. | **hist_drop 6/8 vs notta, 7/8 vs seed_bon** — not one clip. hinge 5/8. cached=seed, sink=notta. Table: [`2026-08-21_wan_v2v_pervideo_retract.md`](paper_tables/2026-08-21_wan_v2v_pervideo_retract.md). |
