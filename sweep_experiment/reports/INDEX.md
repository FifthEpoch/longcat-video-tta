...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`. Caption **N=8**. | **Left queue 31 Aug 01:19.** Need sacct + 8 mp4 before harvest. RF intra closed. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | lastmix / sf_bpseudo / rf_restep **NO**. Crash rerun **left queue 31 Aug 01:19.** Need sacct. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | Hosts scored. **01:19 31 Aug:** Always **16615749** R 8h50; VBench **750** PD. Pseudo **748** left the queue — sacct before call. Do not remake hosts. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge / next-seed / wiggle / latmot. SF+RF. Caption **N=8**. | **Left queue 31 Aug 01:19** (RF generate was already DONE). Need sacct + 8 mp4 + VBench before keep-picture call. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). |
