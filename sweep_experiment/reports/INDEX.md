...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **GENERATE DONE.** VBench job **16122823** user says finished 2026-08-21 AM. Dump pending. | **seed_bon FAIL** on tail motion (−8.8%, 12/32). Table: [`2026-08-21_wan_v2v_confirm_32_sidecar.md`](paper_tables/2026-08-21_wan_v2v_confirm_32_sidecar.md). |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. | **GENERATE DONE.** VBench job **16122824** hist_drop+hinge user says finished. Dump pending. | hist_drop 6/8 vs notta, 7/8 vs seed_bon. |
| `v2v_panda_quiet_32v` + `v2v_panda_tail_8v` | quiet_bon (search only if prefix_motion<0.018); tail_hist (k=1 last-3 replay). | **GENERATE DONE 2026-08-21 AM.** Jobs **16124386** / **16124387**. Dump pending. | Spec: [`2026-08-21_wan_v2v_next_bedtime.md`](paper_tables/2026-08-21_wan_v2v_next_bedtime.md). |
