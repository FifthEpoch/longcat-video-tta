...
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge 10%, next-seed, wiggle 20%+seam, latent first−last pick+seam. SF+RF. Caption **N=8**. | **IN FLIGHT 2026-08-30.** Smoke **16616159–173**. N=8 **16616174–188**. Do not scancel cite 748–750. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). |
