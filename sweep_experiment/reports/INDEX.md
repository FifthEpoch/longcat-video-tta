...
| `v2v_panda_caption_128v` | Paper-size caption V2V. **WAVE=hosts** = notta + rolling. **WAVE=cite** = Pseudo + Always. **N=128**. | **SUBMIT-READY 2026-08-28.** Paste `WAVE=hosts` tonight. GRES only queues. | Do not mix stem `v2v_panda_rolling_128v`. [`hold vs 128`](paper_tables/2026-08-28_hold_vs_n128.md). |
