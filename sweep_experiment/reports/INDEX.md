...
| `t2v_bon_128v_vbenchlong` | Optional T2V *comparison* to Relax Forcing / SF++ / FreqForcing. **Not a task lock** (user 2026-08-18: T2V was not agreed). | **SPEC READY. Not submitted.** | Only if we want that table. Spec: [`2026-08-18_wan_t2v_vbenchlong_128_spec.md`](paper_tables/2026-08-18_wan_t2v_vbenchlong_128_spec.md). |
