...
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge / next-seed / wiggle / latmot. SF+RF. Caption **N=8**. | **RF generate DONE.** SF kind-fix **IN FLIGHT** smoke **16620355–363**, N=8 **364–372**. Do not remake RF. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). |
