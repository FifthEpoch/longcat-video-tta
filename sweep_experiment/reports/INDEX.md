...
| Caption nwarp N=8 spec | Extra-only HIWYN on leftover mean flow. SF host. | SUBMIT-READY. `sf_nwarp` + `sf_nwarp_live`. Cite caption SF first-8. | [`2026-09-06_wan_v2v_caption_nwarp_spec.md`](paper_tables/2026-09-06_wan_v2v_caption_nwarp_spec.md). |
| Caption nwarp N=8 queue | `sf_nwarp` / `sf_nwarp_live` smoke + N=8. | **COMPLETED 0:0.** Smoke gen **17028867/870** 6–7 min + VBench **17028871**. N=8 gen **17028874/875** 17–23 min + VBench **17028876**. Harvest pending paste. | [`experiment_outputs/2026-09-06.md`](experiment_outputs/2026-09-06.md). |
