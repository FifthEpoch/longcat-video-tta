...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | VBench **7/7** all four. Always **50.8% (65)** / Aes 0.503. Pseudo **47.7% (61)** / Aes 0.510 / IQ 72.38. RF Aes **0.529** / subject 0.685. Pixel/FVD incomplete. | [`all metrics`](paper_tables/2026-08-31_wan_v2v_cite128_all_metrics.md). Why pixels blank + Pseudo upgrades: [`tried`](paper_tables/2026-08-31_wan_pseudo_improvements_tried.md). |
...
| Wan Panda-prefix pixel audit | Caption-128 sources: min 55 s / med 314 s / max 1824 s. **128/128 ≥ 32 s.** | **16694796** preempted 2h20. SF/RF/Pseudo done. Always **50/128** jsons. Resubmit skip-existing. | [`all metrics`](paper_tables/2026-08-31_wan_v2v_cite128_all_metrics.md). |
