...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **00:39 2026-08-25.** Pseudo **32/32** tail **+28%** 23/0/9. Always **16310324** 29/32 R. VBench **16310330** PD. | [`outcomes`](paper_tables/2026-08-24_wan_v2v_caption_wave1_outcomes.md). No VBench. No HOLD. |
...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **RESUBMITTED 2026-08-25 00:43.** **16326033** fixed, **034** stream, **035** resid, VBench **16326036**. | First R log must show `\|δ\|=`. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
