...
| `v2v_panda_rolling_128v` | SF notta + rolling_notta. N=128. Same prefix set as N=32. | **TAILS + 6/7 VBench DONE.** Flickering job **16259396**. | Locked bars PASS (subj 0.687 / IQ 70.91 / tail +31%). Dyn median 1.0 (mean 0.53). Host, not ours. Read: [`2026-08-23_wan_v2v_rolling128_vbench6_read.md`](paper_tables/2026-08-23_wan_v2v_rolling128_vbench6_read.md). |
