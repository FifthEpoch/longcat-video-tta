...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | Always official **50.8% (65/128)** / 0.661 / 72.19. Pseudo **47.7% (61)** / 0.660 / 72.38. Mean cost Pseudo **304 s** vs Always **348 s**. All-metric grid: VBench 5/7 in; pixel/FVD incomplete. | [`complete`](paper_tables/2026-08-31_wan_v2v_cite128_complete.md), [`all metrics`](paper_tables/2026-08-31_wan_v2v_cite128_all_metrics.md). |
...
| Wan Panda-prefix pixel audit | Caption-128 sources: min 55 s / med 314 s / max 1824 s. **128/128 ≥ 32 s.** | **16678705** preempted. Only SF PSNR 9.25 / SSIM 0.279. Resubmit skip-existing. | [`spec`](paper_tables/2026-08-31_wan_v2v_pixel_metrics_spec.md). |
