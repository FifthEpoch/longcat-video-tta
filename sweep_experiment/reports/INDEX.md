...
| `v2v_panda_caption_128v` | Paper-size caption V2V: **notta + sf_pseudo + sf_always_search**. **N=128**. | **READY after lastmix/intra harvest.** Was “hosts only”; corrected 2026-08-28. | Field long tables are ~128. Do not mix stem-prompt rolling-128. [`hold vs 128`](paper_tables/2026-08-28_hold_vs_n128.md). |
