...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **IN FLIGHT 2026-08-24.** Generate **16310318–329** PD; VBench **16310330** afterok. Preflight 1000/1000. | Cite vs caption notta. First sidecar must be `metadata_csv`. Spec: [`caption rerun`](paper_tables/2026-08-24_wan_v2v_caption_rerun_spec.md). |
