...
| `v2v_panda_family_32v` | Family A/B/C/D on RF: `rf_rewind`, `rf_sick_search` k=4, `rf_pseudo` k=4, `rf_sink`. **N=32**. Offline chunk-trace on 8/32/128 in the same paste. | **PACK-2 FAILED 2026-08-23.** 273–276 FAILED 2:0/1:0 (15/16/16/5 mp4). 277 afterany — scancel. Resume workers=1 skip-existing. | 2×39 GB KV OOM. [`pack2`](paper_tables/2026-08-23_wan_gpu_pack2_oom.md). Paper baseline SF notta; ablation `rolling_notta`. C is a sink probe, not HG-f. Spec: [`2026-08-23_wan_v2v_family_wave_spec.md`](paper_tables/2026-08-23_wan_v2v_family_wave_spec.md). GPU: [`2026-08-23_wan_gpu_batch_policy.md`](paper_tables/2026-08-23_wan_gpu_batch_policy.md). |
