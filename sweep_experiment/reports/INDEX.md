...
| `v2v_panda_sf_always_32v` | `sf_always_search` k=4. Same pick as pseudo, no prefix gate. **N=32**. | **SPEC READY 2026-08-24.** Submit `submit_v2v_sf_always_search.sh`. | Splits gate vs pick on the +37% win. Spec: [`2026-08-24_wan_v2v_sf_always_search_spec.md`](paper_tables/2026-08-24_wan_v2v_sf_always_search_spec.md). |
