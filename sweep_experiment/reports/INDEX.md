...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **RETRY FAILED 2026-08-25.** **16321558 / 560 / 562** 2:0 inplace IM cache. Fix: skip IM + drop KV. | Not a null. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
