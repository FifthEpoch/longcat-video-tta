...
| `v2v_panda_sf_always_32v` | `sf_always_search` k=4. Same pick as pseudo, no prefix gate. **N=32**. | **IN FLIGHT 2026-08-24.** **16288113** R ~2h14. | Splits gate vs pick. k=4. [`k`](paper_tables/2026-08-24_wan_v2v_always_search_k.md). |
| `v2v_panda_rf_always_32v` | `rf_always_search` k=4 on RF rolling. Same pick as rf_sick/rf_pseudo, no gate. **N=32**. | **IN FLIGHT 2026-08-24.** **16288114** left squeue — sacct before done/fail. VBench **16288115** afterok 113:114. | Host twin. Cite vs `rolling_notta`. |
