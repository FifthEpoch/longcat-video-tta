...
| `v2v_panda_rolling_128v` | SF notta + rolling_notta. N=128. Same prefix set as N=32. | **TAILS DONE 2026-08-22.** 128/128. VBench **16209128** PENDING. | Pair: med **+31%**, mean **+23%**, **88/40**, still 40/21, live 48/19. First 32 bit-match N=32. Quality pending. Table: [`2026-08-22_wan_v2v_rolling128_tails.md`](paper_tables/2026-08-22_wan_v2v_rolling128_tails.md). |
...
| `v2v_panda_host_split_8v` | H1 `sf_roll`/`rf_chunk` + H4 `sf_recache`/`rf_recache`. N=8. H2/H3 offline on existing 8/32/128 mp4s. | **SUBMIT-READY 2026-08-22.** Spec landed. Not yet launched. | Split RF win (weights vs sampler) + VAE recache + chunk-0 host switch. Do not scale from 8. Spec: [`2026-08-22_wan_v2v_host_split_spec.md`](paper_tables/2026-08-22_wan_v2v_host_split_spec.md). |
