...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **GENERATE DONE 2026-08-21.** 32/32 mp4s both dirs. VBench pending. | **seed_bon KILL:** tail motion 0.01018 vs notta 0.01380 (**−26%**). N=8 +35% was a lucky prefix. Table: [`2026-08-21_wan_v2v_confirm_32_and_tricks.md`](paper_tables/2026-08-21_wan_v2v_confirm_32_and_tricks.md). |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. | **GENERATE DONE 2026-08-21.** 8/8 mp4s all 6 methods. VBench pending. | `cached_bon` = seed_bon exact; `sink` = notta exact. **hist_drop +42%** vs notta (only new motion win). hinge +11% (lost to two-sided). late/good_bt HOLD. Table: [`2026-08-21_wan_v2v_confirm_32_and_tricks.md`](paper_tables/2026-08-21_wan_v2v_confirm_32_and_tricks.md). |
