...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **IN FLIGHT 2026-08-24 19:20.** **16310318** notta R 47m; **16310320** rewind R on h200_cds. **16310319** rolling left squeue. Rest PD QOS. VBench **16310330**. | 2-way H200 cap. |
...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **IN FLIGHT 2026-08-24.** **16314667–669** PD; VBench **16314670** afterok. | Cite vs caption notta. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
