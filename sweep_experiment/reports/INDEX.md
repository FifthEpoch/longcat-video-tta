...
| `v2v_panda_sf_family_32v` | Same four widgets on **SF chunked**: `sf_rewind`, `sf_sick_search` k=4, `sf_pseudo` k=4, `sf_sink`. **N=32**. | **SPEC READY 2026-08-24.** | Field claim: method-on-SF vs SF notta. RF rolling is comparison only. No `sf_roll`. Spec: [`2026-08-24_wan_v2v_sf_family_spec.md`](paper_tables/2026-08-24_wan_v2v_sf_family_spec.md). |
