...
| RF non-linear timestep list | Linger-high / dump-early on existing Rolling student. Not leftover ρ. | **SUBMIT-READY.** Smoke without DMD. Train only if Imaging Quality dies. | [`2026-09-01_rf_nonlinear_schedule.md`](paper_tables/2026-09-01_rf_nonlinear_schedule.md). |
| `v2v_panda_caption_schedule_8v` | `rolling_linger` / `rolling_dump`. Caption N=8. Same T as live list. | **SUBMIT-READY 2026-09-03.** Existing student. Cite vs caption Rolling first-8. | [`2026-09-01_rf_nonlinear_schedule.md`](paper_tables/2026-09-01_rf_nonlinear_schedule.md). `submit_v2v_caption_schedule8.sh`. |
