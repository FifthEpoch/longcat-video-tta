...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **16:36 2026-08-25.** VBench **16310330** CANCELLED after SF family. Pseudo Dyn **0**. Sink subject fail. Always/RF VBench leftover. | [`vbench read`](paper_tables/2026-08-25_wan_v2v_caption_vbench_read.md). |
| `v2v_panda_caption_prefix_32v` | Caption Prefix-match: `seed_bon`, `live_bon`, `appear_bon`. **N=32**. | **16:36.** seed/live **32/32** tails −18% / +2%. appear **27/32** cancelled. VBench 467 cancelled. | Resume appear + VBench via `WAVE=leftover`. |
