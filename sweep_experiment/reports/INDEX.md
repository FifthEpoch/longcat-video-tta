...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | Always official **50.8% (65/128)** / 0.661 / 72.19. Pseudo **47.7% (61)** / 0.660 / 72.38. Mean cost Pseudo **304 s** vs Always **348 s**. | [`complete`](paper_tables/2026-08-31_wan_v2v_cite128_complete.md). |
