...
| `v2v_panda_caption_mixctx_8v` | `rf_mix` / `sf_mix` + always-on + `rolling_ctx` / `sf_ctx`. Caption N=8. | **IN-FLIGHT 2026-09-04.** 16931124–125 R; 126–129 PD QOS; VBench **16931130** afterok. Preflight `metadata_csv` assumed (wave already on GPU). | [`spec`](paper_tables/2026-09-04_wan_v2v_caption_mixctx_spec.md). |
| `v2v_panda_caption_fifo_tscore_8v` | `rolling_fifo` / `fifo_sick` + `rf_tscore` / `sf_tscore` + always. Caption N=8. | **IN-FLIGHT 2026-09-04.** 16931441–446 PD Priority; VBench **16931447** afterok. Preflight `metadata_csv` 8/8 `bad=0`. | [`spec`](paper_tables/2026-09-04_wan_v2v_caption_fifo_tscore_spec.md). |
