...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **PROTOCOL PASS 2026-08-24 22:41.** Hosts+rewind 32/32 tails filled. Sick **16310321** left squeue. Pseudo 322 R 1h49; 323–329 R 27m. VBench **16310330** PD. | Generate table: [`outcomes`](paper_tables/2026-08-24_wan_v2v_caption_wave1_outcomes.md). VBench blank. |
...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **16314667–670 not in 22:41 squeue.** sacct before calling done or dead. | Cite vs caption notta. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
