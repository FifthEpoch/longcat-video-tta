...
| `v2v_panda_host_split_32v` | H1 `sf_roll`/`rf_chunk` + H4 `sf_recache`/`rf_recache`. **N=32**. H2/H3 offline on existing 8/32/128 mp4s. | **H2/H3 DONE 2026-08-22.** H1/H4 **16215197–200** PD Priority; VBench **16215201** Dependency. squeue 19:38. | H2 bake **NO** at 128 (med −5.4% vs RF). H3 veto **NO** (med +0.0%). Do not GPU a router. Verdict: [`2026-08-22_wan_v2v_host_switch_verdict.md`](paper_tables/2026-08-22_wan_v2v_host_switch_verdict.md). |
