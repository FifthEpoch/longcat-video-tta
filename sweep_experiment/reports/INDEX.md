...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **PROTOCOL PASS 2026-08-24 20:37.** Hosts+rewind 32/32. **16310321** sick + **16310322** pseudo R 12m. 323–329 + AdaSteer PD QOS. VBench **16310330**. | Handcrafted hosts: [`hosts`](paper_tables/2026-08-24_wan_v2v_caption_wave1_hosts.md). |
