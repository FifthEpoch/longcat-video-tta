...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **SF OOM FIX SUBMIT-READY 2026-08-29.** Keep one KV snap. Paste `WAVE=sf`. RF still NO. | [`oom fix`](paper_tables/2026-08-29_sf_intra_oom_fix.md). [`harvest`](paper_tables/2026-08-27_wan_v2v_intra8_harvest.md). |
