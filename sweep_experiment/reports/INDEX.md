...
| `i2v_bon_32v_hybrid` VBench 5 s windows | Trend: VBench++ on 0–5 … 25–30 of the same 32 mp4s. Full clip stays official. | **IN FLIGHT** job **16009916** (2026-08-19). 3 methods × `w0_5`…`w25_30`. | Analyze when DONE: `analyze_i2v_vbench_trend.py`. |
