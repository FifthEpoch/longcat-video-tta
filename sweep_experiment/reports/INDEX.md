...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`. Caption **N=8**. | **GENERATE+VBENCH DONE.** 741/742 0:0 8/8; **743** 27m. Harvest pending. RF intra already NO. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | lastmix / sf_bpseudo / rf_restep **NO**. **rf_bpseudo** 746 8/8; **747** 18m. `sf_restep` **5/8** (744/745 CANCELLED 2h). Do not remake. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | Hosts scored. **GENERATE DONE:** Pseudo **748** 7h51 128/128; Always **749** 9h26 128/128. VBench **750** CANCELLED 2h — resubmit skip-existing. Do not remake videos. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge / next-seed / wiggle / latmot. SF+RF. Caption **N=8**. | **All 14 dirs 8/8.** SF VBench **372** DONE. RF VBench **188** FAILED 2:0 — resubmit RF dirs only. Harvest SF now; no scale until letter. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). |
