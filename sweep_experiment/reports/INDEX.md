...
| `i2v_bon_32v_sticky` | 32 | 30 s (5×24 lat) | gated-BoN hybrid + stay-on (reuse hybrid NOTTA / always-search) | **READY TO SUBMIT** `submit_i2v_bon32_sticky.sh` | `wan_experiment/results/i2v_bon_32v_sticky/` | Once any alarm fires, later pieces keep searching (`already_on`). Same 32 images/seeds. Built to catch 03/24 without waking 06/07 early. Spec: [`2026-08-18_wan_i2v_sticky_gate_spec.md`](paper_tables/2026-08-18_wan_i2v_sticky_gate_spec.md). |
