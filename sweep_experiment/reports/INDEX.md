...
| `v2v_panda_family_32v` | Family A/B/C/D on RF: `rf_rewind`, `rf_sick_search` k=4, `rf_pseudo` k=4, `rf_sink`. **N=32**. Offline chunk-trace on 8/32/128 in the same paste. | **SPEC READY / submitting 2026-08-23.** | Paper baseline SF notta; ablation `rolling_notta`. C is a sink probe, not HG-f. Generate = H200 × 2 video workers; VBench = L40S. Spec: [`2026-08-23_wan_v2v_family_wave_spec.md`](paper_tables/2026-08-23_wan_v2v_family_wave_spec.md). GPU: [`2026-08-23_wan_gpu_batch_policy.md`](paper_tables/2026-08-23_wan_gpu_batch_policy.md). |
