...
| `v2v_panda_caption_mixctx_8v` | `rf_mix` / `sf_mix` + always-on + `rolling_ctx` / `sf_ctx`. Caption N=8. | **SUBMIT-READY 2026-09-04.** Diagnostic. Not leftover ρ. | [`spec`](paper_tables/2026-09-04_wan_v2v_caption_mixctx_spec.md). `submit_v2v_caption_mixctx.sh`. |
| `v2v_panda_caption_fifo_tscore_8v` | `rolling_fifo` / `fifo_sick` + `rf_tscore` / `sf_tscore` + always. Caption N=8. | **SUBMIT-READY 2026-09-04.** FIFO = Kim lookahead. tscore = 1.3B freeze-score, not Wan-14B. | [`spec`](paper_tables/2026-09-04_wan_v2v_caption_fifo_tscore_spec.md). `submit_v2v_caption_fifo_tscore.sh`. |
