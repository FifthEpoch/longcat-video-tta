...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **IN FLIGHT 2026-08-21 02:16.** **16113805** left queue (notta, likely done). **16113806** seed_bon still R 2:16:05 on gh127. | Confirm or kill the N=8 motion/Dyn win. Spec: [`2026-08-20_wan_v2v_confirm_32_spec.md`](paper_tables/2026-08-20_wan_v2v_confirm_32_spec.md). Do not scancel 16113806. Partial per-video json is scorable. |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. Pair via `--baseline-dir v2v_panda_bakeoff_8v`. | **LEFT QUEUE 2026-08-21 02:16.** Jobs **16115844–849** gone from squeue (not pending). Fate unknown until `sacct`. | Spec: [`2026-08-20_wan_v2v_tricks_8v_spec.md`](paper_tables/2026-08-20_wan_v2v_tricks_8v_spec.md). |
