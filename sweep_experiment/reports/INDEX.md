...
| `v2v_panda_bakeoff_8v` | notta, seed_bon, motion_bon, backtrack. **No shift_search** (probe dead). | **SUBMIT-READY.** `SKIP_SHIFT=1`. Pull first (backtrack ignores 6336-scale drift). | Smoke tail motion 0.0106. Last-chunk drift 6336 is not a quality number. |
