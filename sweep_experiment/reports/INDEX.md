...
| `v2v_panda_rolling_128v` | SF notta + rolling_notta. N=128. Same prefix set as N=32. | **SUBMIT-READY 2026-08-22.** `submit_v2v_rolling128.sh`. Fresh pair, not confirm_32v. | Only N=32 host that passed locked bars. Host, not our controller. Kill rules: [`2026-08-22_wan_v2v_rolling128_spec.md`](paper_tables/2026-08-22_wan_v2v_rolling128_spec.md). |
| `v2v_panda_rolling_leftovers_8v` | rolling_rho_lo/hi, rolling_adapt, rolling_look. N=8. | **SUBMIT-READY 2026-08-22.** `submit_v2v_rolling_leftovers.sh`. | Ideas 4 + 6/7 on the RF host. Compare to lineage rolling_notta. Cover: [`2026-08-22_wan_v2v_leftovers_cover.md`](paper_tables/2026-08-22_wan_v2v_leftovers_cover.md). |
