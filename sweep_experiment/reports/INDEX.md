...
| `i2v_notta_16v` | 16 | 5 s + 30 s | NOTTA | **DONE 2026-08-16** n_ok=16/16 both | `wan_experiment/results/i2v_notta_16v/{h5s,h30s}_shard0/` | 5 s mean 9.61 s/clip; 30 s mean 38.32 s/clip. Drift vs horizon not yet scored. |
