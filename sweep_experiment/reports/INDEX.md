...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **SUBMIT-READY 2026-08-25.** | Block abort on freeze or 1.5× sharp/sat. Spec: [`intra`](paper_tables/2026-08-25_wan_v2v_intra_chunk_spec.md). |
