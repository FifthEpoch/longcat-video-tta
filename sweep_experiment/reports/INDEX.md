...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **RESUBMITTED 2026-08-24 22:50.** **16321558** fixed, **560** stream, **562** resid, VBench **16321563**. PD behind WAVE=1. | First R log must show `\|δ\|=`. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
