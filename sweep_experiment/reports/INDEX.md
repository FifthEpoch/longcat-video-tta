...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **00:37 2026-08-25.** **16310324** always R 2h51. Pseudo **16310322** left squeue — harvest. VBench **16310330** still PD. | [`outcomes`](paper_tables/2026-08-24_wan_v2v_caption_wave1_outcomes.md). No VBench. No HOLD. |
...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **16321558 / 560 / 562 / 563 left squeue 00:37.** sacct + sidecar before calling. | Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). |
