...
| `v2v_panda_live_32v` | live_bon only. N=32. Same prefix set as confirm_32v. live_min=0.012. | **SUBMIT-READY 2026-08-21.** Yes/no shot. Reuse confirm notta. | Spec: [`2026-08-21_wan_v2v_live32_yesno.md`](paper_tables/2026-08-21_wan_v2v_live32_yesno.md). `bash wan_experiment/sbatch/submit_v2v_live32.sh`. |
