...
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge / next-seed / wiggle / latmot. SF+RF. Caption **N=8**. | **RF generate DONE.** SF 2-video **PASS** (355–361 COMPLETED 2 mp4; 360/362 still writing). N=8 **364–371** leave running. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). Success bar: [`neighbors`](paper_tables/2026-08-30_wan_success_and_neighbors.md). |
