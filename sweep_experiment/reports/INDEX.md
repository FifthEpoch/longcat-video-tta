...
| `panda_ood_budget_1000v_preview` | Panda segment pool | 998 | 12-config grid + NOTTA | **DONE 2026-07-21** — 12 configs + NOTTA merged (13 merged_summary.json), VBench backfilled (120 dirs/840 files, 70/config), 4 routers trained (jobs 14434827–30 COMPLETED). | `sweep_experiment/results/panda_ood_budget_1000v_preview/` | [`2026-07-21_router_1000v_vs_200v_pilot.md`](paper_tables/2026-07-21_router_1000v_vs_200v_pilot.md), [`2026-07-19_budget_grid_1000v_preview.md`](paper_tables/2026-07-19_budget_grid_1000v_preview.md) | **Learned routing does NOT scale:** PSNR router captures only 3.3% of oracle (+0.013 dB vs fixed ≈ fixed; oracle headroom shrank +0.75→+0.38 dB). Every learned VBench router (Blocks A/B/C, 9–159d) captures NEGATIVE (best −1.6%) — pilot's 20.8% was a small-N artifact. Pick agreement 12.5%→39% as landscape flattens (ρ 0.999). Fixed AdaSteer FVD 68.8 ≪ NOTTA 157.0 (population, N mismatch). |
