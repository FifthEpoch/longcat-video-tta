...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **16:31 2026-08-25.** Queue empty. VBench **16310330** left squeue. Harvest official dims. | [`outcomes`](paper_tables/2026-08-24_wan_v2v_caption_wave1_outcomes.md). |
| `v2v_panda_caption_prefix_32v` | Caption Prefix-match: `seed_bon`, `live_bon`, `appear_bon`. **N=32**. | **16:31 2026-08-25.** **16328464–467** off queue. Harvest. | Cite vs caption notta. [`prefix32`](paper_tables/2026-08-25_wan_v2v_caption_prefix32_spec.md). |
| `v2v_panda_caption_cross_32v` | Caption crossed host: `sf_roll` / `rf_chunk`. **N=32**. | **16:31 2026-08-25.** **16328612–614** off queue. Harvest. Expect H1 twitch. | [`slide audit`](paper_tables/2026-08-25_wan_v2v_slide_caption_audit.md). |
