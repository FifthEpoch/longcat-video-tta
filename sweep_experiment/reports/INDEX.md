...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **16:45.** Leftover VBench **16350479** R gl005. SF family official already written. | [`vbench read`](paper_tables/2026-08-25_wan_v2v_caption_vbench_read.md). |
| `v2v_panda_caption_prefix_32v` | Caption Prefix-match: `seed_bon`, `live_bon`, `appear_bon`. **N=32**. | **16:45.** appear resume **16350480** R gh134. Prefix VBench **16350481** PD. | seed/live 32/32 already. |
