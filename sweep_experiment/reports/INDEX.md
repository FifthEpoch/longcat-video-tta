...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **IN FLIGHT 2026-08-20.** Jobs **16113805** (notta, gh116) / **16113806** (seed_bon, gh119). Running 13 min as of 22:26. | Confirm or kill the N=8 motion/Dyn win. Spec: [`2026-08-20_wan_v2v_confirm_32_spec.md`](paper_tables/2026-08-20_wan_v2v_confirm_32_spec.md). Do not scancel. |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. Pair via `--baseline-dir v2v_panda_bakeoff_8v`. | **IN FLIGHT 2026-08-20.** Jobs **16115844–849** (hinge/late/hist/good_bt/cached/sink). All PD `QOSGrpGRES` on `h200_cour` behind the N=32 pair. | Tests H-match (hinge vs two-sided), late-only search, history dropout, good-chunk backtrack, KV snapshot, sink+window replay. Spec: [`2026-08-20_wan_v2v_tricks_8v_spec.md`](paper_tables/2026-08-20_wan_v2v_tricks_8v_spec.md). |
