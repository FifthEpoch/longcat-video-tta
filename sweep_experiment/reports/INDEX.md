...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **SF still OOM 2026-08-30.** 045/048 H200 2:0 (3× GPU KV). CPU-snap fix ready, smoke not launched. RF still NO. | [`oom`](paper_tables/2026-08-30_wan_v2v_oom_cpu_snap.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V hosts. **N=128**. | **DONE 2026-08-29.** 256 mp4. VBench **16545806**. SF 0.666 / 72.07 / **Dyn 32.8% (42/128)** / tail 0.0119. Rolling 0.685 / 71.52 / Dyn **28.9%** / tail +33%. | Cite 128 SF. Rolling tail YES, official Dyn% NO. WAVE=cite not launched. [`hosts`](paper_tables/2026-08-30_wan_v2v_caption128_hosts.md). |
