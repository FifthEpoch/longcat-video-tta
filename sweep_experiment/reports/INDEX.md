...
| `v2v_panda_family_32v` | Family A/B/C/D on RF: `rf_rewind`, `rf_sick_search` k=4, `rf_pseudo` k=4, `rf_sink`. **N=32**. Offline chunk-trace on 8/32/128 in the same paste. | **GENERATE+VBENCH DRAINED 2026-08-24.** Dual wave 007–011 and 080–087; both VBench R ~1.5 h then empty queue. Harvest before cite. | workers=1 skip-existing. Do not resubmit. 2×39 GB KV OOM. [`pack2`](paper_tables/2026-08-23_wan_gpu_pack2_oom.md). Paper baseline SF notta; ablation `rolling_notta`. C is a sink probe, not HG-f. Spec: [`2026-08-23_wan_v2v_family_wave_spec.md`](paper_tables/2026-08-23_wan_v2v_family_wave_spec.md). GPU: [`2026-08-23_wan_gpu_batch_policy.md`](paper_tables/2026-08-23_wan_gpu_batch_policy.md). |
