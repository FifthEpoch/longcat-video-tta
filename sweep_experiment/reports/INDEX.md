...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **PROTOCOL PASS 2026-08-24 20:26.** notta/rolling/rewind **32/32 COMPLETED 0:0**, `prompt_source=metadata_csv`. Tails 0.01164 / 0.01423 / 0.01262 (handcrafted). **16310321** sick R. 322–329 + AdaSteer PD. VBench **16310330**. | Caption SF notta is the cite baseline. No VBench yet. [`hosts`](paper_tables/2026-08-24_wan_v2v_caption_wave1_hosts.md). |
