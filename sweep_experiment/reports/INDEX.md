...
| `v2v_panda_rolling_128v` | SF notta + rolling_notta. N=128. Same prefix set as N=32. | **TAILS DONE.** notta VBench in. rolling VBench **16228045** resubmitted (09128 cancelled mid-subject). | Motion +31% holds. **Do not cite YES** until 16228045. Tails: [`2026-08-22_wan_v2v_rolling128_tails.md`](paper_tables/2026-08-22_wan_v2v_rolling128_tails.md). |
