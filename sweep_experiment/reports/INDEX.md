...
| `i2v_bon_32v_hybrid` | 32 | 30 s (5×24 lat) | NOTTA, always-BoN k=4, gated-BoN hybrid (ch1>0.8 / late>2.0 / Δ>0.5∧prev>0.5) | **READY TO SUBMIT** `submit_i2v_bon32_hybrid.sh` | `wan_experiment/results/i2v_bon_32v_hybrid/` | Hybrid gate + per-chunk traces (`gate_trace.jsonl`, incoming/Δ/reason/per-signal devs). Hypothesis: gated−always last-chunk mean flips from +0.15 to ~−0.2 if 05/02/09/12 fire and 06/07 stay skipped early. Spec: [`2026-08-17_wan_i2v_hybrid_gate_spec.md`](paper_tables/2026-08-17_wan_i2v_hybrid_gate_spec.md). |
