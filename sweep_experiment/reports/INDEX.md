...
| `v2v_panda_caption_prefix_32v` | Caption Prefix-match: `seed_bon`, `live_bon`, `appear_bon`. **N=32**. | **SUBMIT-READY 2026-08-25.** WAVE=1 family already caption 32/32. | Slide rows still stem. Spec: [`prefix32`](paper_tables/2026-08-25_wan_v2v_caption_prefix32_spec.md). No AdaSteer N=32. No WAVE=2 dump. |
| `v2v_panda_caption_closed_32v` | WAVE=2: seed/quiet/live/appear + host-split. **N=32**. | **DO NOT SUBMIT.** Prefix-only wave covers the slide. Host-split / quiet stay closed. | `sf_roll` is NO. |
