...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **HARVEST 2026-08-27.** SF FAILED 2:0 8 json/0 mp4 (523/524/530/532). RF 533/534 8/8. | RF twins **identical** 0.645/66.33/Dyn 1 **NO**. SF dead until traceback. [`harvest`](paper_tables/2026-08-27_wan_v2v_intra8_harvest.md). |
