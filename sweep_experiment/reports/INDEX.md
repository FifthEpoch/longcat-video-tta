...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **GENERATE DONE 2026-08-21.** 32/32 sidecars paired. VBench **16122823** PD `QOSGrpGRES`. | **seed_bon FAIL:** 0.01235 vs 0.01353 (**−8.8%, 12/32**). First 8 still +34% (bake-off match). Last 24 −19%. Hot prefixes 0/7. Table: [`2026-08-21_wan_v2v_confirm_32_sidecar.md`](paper_tables/2026-08-21_wan_v2v_confirm_32_sidecar.md). |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. | **GENERATE DONE 2026-08-21.** 8/8 all 6. VBench **16122824** hist_drop+hinge PD `QOSGrpGRES`. | hist_drop 6/8 vs notta, 7/8 vs seed_bon (increment, not a new mode). Do not scale to 32 until VBench. Tables: [`2026-08-21_wan_v2v_pervideo_retract.md`](paper_tables/2026-08-21_wan_v2v_pervideo_retract.md), sidecar confirm above. |
| `v2v_panda_quiet_32v` + `v2v_panda_tail_8v` | quiet_bon (search only if prefix_motion<0.018); tail_hist (k=1 last-3 replay). | **SUBMIT-READY.** `NEXT=1 bash wan_experiment/sbatch/submit_v2v_bakeoff.sh` | Causal test of N=32 0/7 hot-prefix damping + “is hist_drop just short history?” No hist_drop-32. Spec: [`2026-08-21_wan_v2v_next_bedtime.md`](paper_tables/2026-08-21_wan_v2v_next_bedtime.md). |
