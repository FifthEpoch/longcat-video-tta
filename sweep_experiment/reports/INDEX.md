...
| `v2v_panda_bakeoff_8v` | notta, seed_bon, motion_bon, backtrack. **No shift_search** (probe dead). | **IN FLIGHT 2026-08-20.** Jobs **16092846** notta, **16092847** seed_bon, **16092848** motion_bon, **16092849** backtrack. N=8. HEAD `c8c5af1`. | Do not VBench until all four COMPLETED. Analyzer: `analyze_v2v_bakeoff.py`. |
