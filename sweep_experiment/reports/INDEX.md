...
| `v2v_panda_caption_pseudo_next_8v` | Cheapen + re-gate: `sf_pseudo_cached`, `sf_always_cached`, `sf_repseudo`, `sf_repseudo_cached`. Caption **N=8**. | **IN FLIGHT.** Smoke **16679371–375**. N=8 **16679376–379** + VBench **16679380**. | [`spec`](paper_tables/2026-08-31_wan_v2v_pseudo_next8_spec.md). |
...
| Wan Panda-prefix pixel audit | Caption-128 sources: min 55 s / med 314 s / max 1824 s. **128/128 ≥ 32 s.** | **IN FLIGHT** L40S **16678705**. No new generate. | [`spec`](paper_tables/2026-08-31_wan_v2v_pixel_metrics_spec.md). Headline stays VBench + Dyn%. |
