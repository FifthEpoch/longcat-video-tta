...
| `i2v_bon_32v_sick` | 32 | 30 s (5×24 lat) | gated-BoN search-while-sick (sticky + off if recovered>0.5 or outgoing<1.0) | **READY TO SUBMIT** `submit_i2v_bon32_sick.sh` | `wan_experiment/results/i2v_bon_32v_sick/` | Stay on only while the last second looks sick. Built to keep 11/16 hybrid wins and 03/24 always-search catches. Spec: [`2026-08-18_wan_i2v_sick_gate_spec.md`](paper_tables/2026-08-18_wan_i2v_sick_gate_spec.md). |
