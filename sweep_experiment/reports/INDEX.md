...
**Owners:** Wenchen (PI) and any active agent. Last updated: 2026-08-20.
...
| `v2v_panda_bakeoff_8v` | notta, seed_bon, motion_bon, backtrack. **No shift_search** (probe dead). | **DONE 2026-08-20.** Generate 16092846–849 + VBench `joined.json` n=8. | **seed_bon PROMOTE** under locked rule: tail motion +35%, IQ −0.60, subject +0.0005, Dyn med 0→0.5. motion_bon HOLD. backtrack IQ −2.94. Table: [`2026-08-20_wan_v2v_bakeoff_8v_vbench.md`](paper_tables/2026-08-20_wan_v2v_bakeoff_8v_vbench.md). Plain read: [`2026-08-20_wan_v2v_what_happened.md`](paper_tables/2026-08-20_wan_v2v_what_happened.md). |
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **IN FLIGHT 2026-08-20.** Jobs **16113805** (notta) / **16113806** (seed_bon). Cluster pulled `7371ea3` then submitted. | Confirm or kill the N=8 motion/Dyn win. Spec: [`2026-08-20_wan_v2v_confirm_32_spec.md`](paper_tables/2026-08-20_wan_v2v_confirm_32_spec.md). Do not scancel. |
| `v2v_panda_tricks_8v` | hinge_bon, late_bon, hist_drop, good_backtrack, cached_bon, sink. Same 8 Panda prefixes as bake-off. Pair via `--baseline-dir v2v_panda_bakeoff_8v`. | **SUBMIT-READY.** `TRICKS=1 bash wan_experiment/sbatch/submit_v2v_bakeoff.sh` | Tests H-match (hinge vs two-sided), late-only search, history dropout, good-chunk backtrack, KV snapshot, sink+window replay. No motion_bon / dead-tail backtrack / shift. Spec: [`2026-08-20_wan_v2v_tricks_8v_spec.md`](paper_tables/2026-08-20_wan_v2v_tricks_8v_spec.md). Hypotheses: [`2026-08-20_wan_v2v_sampling_hypotheses.md`](paper_tables/2026-08-20_wan_v2v_sampling_hypotheses.md). |
| Wan non-weight next methods | Motion verifier, `{shift,cfg}` probe, prefix backtrack now hosted on V2V (not T2V 128). CachedSearch / sink-ckpt / HG-f stay wave 2. | Wave 1 implemented in `run_v2v_chunked.py`. | **No TTC.** Memo: [`2026-08-18_wan_nonweight_next.md`](paper_tables/2026-08-18_wan_nonweight_next.md). Spec: [`2026-08-20_wan_v2v_sampling_bakeoff_spec.md`](paper_tables/2026-08-20_wan_v2v_sampling_bakeoff_spec.md). |
