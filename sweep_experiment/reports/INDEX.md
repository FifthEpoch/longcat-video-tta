...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | VBench **7/7**. Pixel PSNR/SSIM **DONE** (SF 9.25 / RF 7.98 / Pseudo 9.22 / Always 9.21). LPIPS/FVD open. Always **50.8% (65)** / Aes 0.503. Pseudo **47.7% (61)** / IQ 72.38. RF subject 0.685. Wall **108 / 47 / 294 / 354** (job/96). | [`all metrics`](paper_tables/2026-08-31_wan_v2v_cite128_all_metrics.md). Pixels: [`2026-09-01`](paper_tables/2026-09-01_wan_v2v_cite128_pixel.md). Wall: [`2026-09-01`](paper_tables/2026-09-01_wan_v2v_cite128_wall.md). |
...
| `v2v_panda_caption_leftovers_8v` | Caption replay of leftover ρ / look. Host = caption-32 Rolling. **N=8**. | **IN FLIGHT 2026-09-01.** 16734909–912 generate; VBench **16734913** afterok. Preflight PASS (1000 captions, 0 stem). | Cite vs caption Rolling. Spec: [`2026-09-01_wan_v2v_caption_leftovers_spec.md`](paper_tables/2026-09-01_wan_v2v_caption_leftovers_spec.md). |
...
| Wan Panda-prefix pixel audit | Caption-128 sources: min 55 s / med 314 s / max 1824 s. **128/128 ≥ 32 s.** | PSNR/SSIM **DONE**. LPIPS/FVD **submit** `submit_v2v_lpips_fvd.sh`. | [`pixel`](paper_tables/2026-09-01_wan_v2v_cite128_pixel.md). [`lpips+fvd`](paper_tables/2026-09-01_wan_v2v_lpips_fvd_spec.md). |
