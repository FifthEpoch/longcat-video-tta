...
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge / next-seed / wiggle / latmot. SF+RF. Caption **N=8**. | **RF YES generate.** Smoke+N=8 SF **FAILED 2:0** (kind bug). RF 8/8 except latmot_always still writing. **SF resubmit** after kind fix. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). |
