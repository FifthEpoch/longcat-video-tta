...
| `v2v_panda_lineage_8v` | live_bon, live_hist, longlive_notta, longlive_sink, longlive_prefix_sink, longlive_live_bon, rolling_notta. Same 8. | **SUBMIT-READY 2026-08-21.** `bash wan_experiment/sbatch/submit_v2v_lineage.sh` | SF live_* immediate; LongLive/RF after CPU download. VBench full chained. Spec: [`2026-08-21_wan_v2v_lineage_overnight.md`](paper_tables/2026-08-21_wan_v2v_lineage_overnight.md). |
