...
| `i2v_bon_32v_sick` | 32 | 30 s (5×24 lat) | gated-BoN search-while-sick (sticky + off if recovered>0.5 or outgoing<1.0) | **SUBMITTED** job 15959146 (Priority) | `wan_experiment/results/i2v_bon_32v_sick/` | Stay on only while the last second looks sick. Built to keep 11/16 hybrid wins and 03/24 always-search catches. Spec: [`2026-08-18_wan_i2v_sick_gate_spec.md`](paper_tables/2026-08-18_wan_i2v_sick_gate_spec.md). Briefing: [`2026-08-18_wan_controller_briefing.md`](paper_tables/2026-08-18_wan_controller_briefing.md). |
...
| `i2v_bon_32v_hybrid` official VBench | Paper-blocking. Handcrafted last-chunk is the controller signal, not the quality claim. 11/16 showed the pick-score can lie. Need do-nothing / always / gated on common VBench dims + Spearman vs last-chunk. | mp4s DONE. Job not submitted until cluster `git pull` + `submit_i2v_vbench_hybrid32.sh`. | **RUN NEXT.** last5 then full. No PSNR (no 30 s GT on these stills). Spec: [`2026-08-18_wan_i2v_official_eval_spec.md`](paper_tables/2026-08-18_wan_i2v_official_eval_spec.md). |
