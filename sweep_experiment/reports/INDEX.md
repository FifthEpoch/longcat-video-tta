...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`. Caption **N=8**. | **IN FLIGHT 2026-08-30.** **16615741** / **16615742**; VBench **16615743**. CPU-snap. RF intra closed. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | lastmix / sf_bpseudo / rf_restep **NO**. Crash rerun **IN FLIGHT:** restep **16615744/745**, rf_bpseudo **16615746**, VBench **16615747**. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. Hosts **DONE**. Cite = Pseudo + Always. | Hosts scored. **CITE IN FLIGHT:** Pseudo **16615748**, Always **16615749** (first 32 copied), VBench **16615750**. Do not remake hosts. | [`jobs`](paper_tables/2026-08-30_wan_v2v_cite128_jobs.md). |
| `v2v_panda_caption_keep_8v` | Picture-preserving mid-chunk: nudge / next-seed / wiggle / latmot. SF+RF. Caption **N=8**. | **RF generate DONE.** SF 2-video **PASS** (355–361 COMPLETED 2 mp4; 360/362 still writing). N=8 **364–371** leave running. | [`jobs`](paper_tables/2026-08-30_wan_v2v_keep8_jobs.md). Success bar: [`neighbors`](paper_tables/2026-08-30_wan_success_and_neighbors.md). Beat-RF path: [`rf-intervene`](paper_tables/2026-08-30_wan_rf_intervene.md). |
