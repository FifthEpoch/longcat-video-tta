...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **19:08.** Always VBench 0.687/71.16/0. RF family written except **rf_sink**. 479 CANCELLED 2h17. | [`official`](paper_tables/2026-08-25_wan_v2v_caption_official.md). |
