...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **02:23 2026-08-25.** Generate off queue (always **16310324** left after 3h08 / was 29/32). VBench **16310330** R 1h10. Harvest Always n + official dims when 330 finishes. | [`outcomes`](paper_tables/2026-08-24_wan_v2v_caption_wave1_outcomes.md). No HOLD. Do not mix stem VBench. |
...
| `v2v_panda_adasteer_8v` | AdaSteer on SF V2V: `ada_fixed`, `ada_stream`, `ada_resid`. Captions. **N=8**. | **02:23 2026-08-25.** **16326033–035** left squeue after R ~8–10 min. VBench **16326036** gone. sacct + harvest before crash vs 8/8. | Cite vs caption notta first 8. Spec: [`adasteer`](paper_tables/2026-08-24_wan_v2v_adasteer_spec.md). No N=32. |
