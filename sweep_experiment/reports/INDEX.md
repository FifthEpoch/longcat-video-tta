...
| `i2v_bon_32v_hybrid` official VBench | Paper-blocking outcome scorecard. | **DONE** 15959601+15984561. last5 + full, 32 paired. | **No quality win.** last5: do-nothing best IQ/background; dynamic median 0 all methods; gated Aes worse than always (−0.026). last-chunk vs IQ ρ positive. Read: [`2026-08-18_wan_i2v_bon32_vbench_read.md`](paper_tables/2026-08-18_wan_i2v_bon32_vbench_read.md). |
