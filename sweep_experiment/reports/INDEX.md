...
| `v2v_panda_host_split_32v` | H1 `sf_roll`/`rf_chunk` + H4 `sf_recache`/`rf_recache`. **N=32** (N=8 draft never launched). H2/H3 offline on existing 8/32/128 mp4s. | **SUBMIT-READY 2026-08-22.** First run is 32. Not yet launched. | Same first 32 as confirm/forward. Do not start another lucky-8. Spec: [`2026-08-22_wan_v2v_host_split_spec.md`](paper_tables/2026-08-22_wan_v2v_host_split_spec.md). |
