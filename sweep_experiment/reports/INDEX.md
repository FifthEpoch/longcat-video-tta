...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **SF RESUBMIT FAILED 2026-08-27.** 16471672–677 **2:0**. N=8 **OOM** (~877 MB, 353 MB free on 141 GB H200). RF still NO. | Do not relaunch. Not the KV TypeError. [`harvest`](paper_tables/2026-08-27_wan_v2v_intra8_harvest.md). |
| `v2v_panda_caption_denoise_8v` | Last-step mix, block pseudo-future, remaining-step restart. Caption **N=8**. | **LASTMIX 8/8 + smoke 2/2 on disk.** 32 + 8 mp4. 833 n_ok=8. Punch/mix fired. VBench 832/837 0:0. Analyze pending. | Gate alive. Do not paste bpseudo/restep until call. Spec: [`2026-08-28_wan_v2v_denoise_hooks_spec.md`](paper_tables/2026-08-28_wan_v2v_denoise_hooks_spec.md). |
...
| `v2v_panda_caption_128v` | Paper-size caption V2V. **WAVE=hosts** = notta + rolling. **WAVE=cite** = Pseudo + Always. **N=128**. | **GENERATE DONE 2026-08-28.** 256 mp4 (128+128). 077 n_ok=128. VBench **079 CANCELLED** — resubmit score-only. | Do not regenerate. [`hold vs 128`](paper_tables/2026-08-28_hold_vs_n128.md). |
