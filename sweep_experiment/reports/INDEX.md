...
| `v2v_panda_caption_intra_8v` | Intra-chunk motion+appear: `sf_intra`, `sf_intra_always`, `rf_intra`, `rf_intra_always`. Caption **N=8**. | **HARVEST 2026-08-27.** RF NO. SF crash = shadowed `_restore_kv`. Fix on main; `WAVE=sf` resubmit. | RF twins identical 0.645/66.33/Dyn 1. [`harvest`](paper_tables/2026-08-27_wan_v2v_intra8_harvest.md). |
