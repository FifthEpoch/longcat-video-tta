...
**Owners:** Wenchen (PI) and any active agent. Last updated: 2026-08-22.
...
| `v2v_panda_rolling_128v` | SF notta + rolling_notta. N=128. Same prefix set as N=32. | **TAILS DONE.** VBench **16209128 CANCELLED** 2h06: notta `joined.json` in (subj 0.648 IQ 70.20 Dyn 0). rolling subject killed 91/128. | Motion +31% holds. **Do not cite YES.** Resubmit rolling VBench only. Tails: [`2026-08-22_wan_v2v_rolling128_tails.md`](paper_tables/2026-08-22_wan_v2v_rolling128_tails.md). |
...
| `v2v_panda_host_split_32v` | H1 `sf_roll`/`rf_chunk` + H4 `sf_recache`/`rf_recache`. **N=32**. H2/H3 offline. | **PARTIAL 2026-08-23.** 197/199/200 COMPLETED. **198 rf_chunk FAILED** 0 mp4. VBench 201 scored 3/4. | `sf_roll` sampler live (+108% vs SF, Dyn 1; subject fail vs RF). `sf_recache` NO. `rf_recache` HOLD (+6.6% uniform). Read: [`2026-08-23_wan_v2v_host_split32_read.md`](paper_tables/2026-08-23_wan_v2v_host_split32_read.md). |
