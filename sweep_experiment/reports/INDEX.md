...
| `v2v_panda_confirm_32v` | notta vs seed_bon only. N=32. Same V2V protocol. | **SUBMIT-READY.** `CONFIRM=1 bash wan_experiment/sbatch/submit_v2v_bakeoff.sh` | Confirm or kill the N=8 motion/Dyn win. Spec: [`2026-08-20_wan_v2v_confirm_32_spec.md`](paper_tables/2026-08-20_wan_v2v_confirm_32_spec.md). |
| V2V sampling-space next tricks | Hypotheses after N=8: H-match (seed_bon = match moving prefix), hinge verifier, late-only search, attention sink, history-dropout, good-chunk backtrack, CachedSearch. | **NOT SUBMITTED.** Memo only. | [`2026-08-20_wan_v2v_sampling_hypotheses.md`](paper_tables/2026-08-20_wan_v2v_sampling_hypotheses.md). First cheap probe if user wants: prefix-match hinge on the same 8 videos. |
