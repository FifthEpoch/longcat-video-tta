...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **SUBMIT-READY 2026-08-24.** `submit_v2v_caption_rerun.sh`. | Stem tables stay audit. Cite vs caption notta. Spec: [`caption rerun`](paper_tables/2026-08-24_wan_v2v_caption_rerun_spec.md). |
