...
| `v2v_panda_bakeoff_8v` | notta, seed_bon, motion_bon, backtrack. **No shift_search** (probe dead). | **GENERATE DONE.** VBench `joined.json` **on disk** for all 4 methods (2026-08-20 21:08). Extra score job **16110491** will skip. | seed_bon tail motion +35% vs notta. Analyze with fixed reader (`a8f73cb`). Table: [`2026-08-20_wan_v2v_bakeoff_8v.md`](paper_tables/2026-08-20_wan_v2v_bakeoff_8v.md). |
