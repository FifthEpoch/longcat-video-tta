...
| `v2v_panda_caption_32v` | Caption-conditioned notta + rolling + sf_pseudo + both always-search. **N=32**. | **WAITING GO.** Captions confirmed in `metadata.csv` (1000/1000). | First real-caption protocol. Do not mix stem-prompt numbers. Spec: [`caption rerun`](paper_tables/2026-08-24_wan_v2v_caption_rerun_spec.md). |
