...
| `v2v_panda_caption_32v` | Caption replay WAVE=1: notta, rolling, SF/RF family, both always-search. **N=32**. | **IN FLIGHT 2026-08-24 20:18.** **16310318** notta R 1h44 gh125. **16310319** rolling and **16310320** rewind left squeue — check sidecars now. 321–329 + AdaSteer PD QOS. VBench **16310330**. | 2-way H200 cap. One slot free; if QOS persists, sacct 319/320. |
