...
def main():
    ...
    validate_tta_feature_budget(args, context="norm_tune")
    ...
    for idx, entry in enumerate(videos):
        ...
        try:
            ...
            # Only hold out a val split if it will be consumed (early stopping);
            # otherwise adapt on all observed frames rather than discarding ~25%
            # of the TTA signal to an unused holdout.
