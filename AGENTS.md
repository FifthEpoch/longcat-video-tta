...
- **In-flight cluster jobs** (as of 2026-08-30 14:56):
  ...
  keep-8 RF generate **DONE** (latmot_always may still write).
  keep-8 SF **FAILED** kind-bug; WAVE=sf resubmit. rf_bpseudo
  **16615746 COMPLETED**. Do not remake RF or 128 hosts.
  **No I2V. No TTC.**
