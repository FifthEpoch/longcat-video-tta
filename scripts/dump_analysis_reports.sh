...
print_file "${BASE}/predictor_transfer/baseline_outcome_predictors.md"
print_file "${BASE}/predictor_transfer/feature_outcome_battery.md"
print_file "${BASE}/predictor_transfer/router_auc_summary.md"
